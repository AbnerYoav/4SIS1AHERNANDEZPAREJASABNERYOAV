...
public class Ventana22 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Representa el daño físico o cuerpo a cuerpo. Algunas criaturas pueden ser más vulnerables a los ataques físicos que a los elementales, y algunos personajes del grupo están especializados en habilidades físicas.");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 260, 500, -1));

        jTextField1.setBackground(new java.awt.Color(255, 153, 102));
        jTextField1.setFont(new java.awt.Font("Segoe UI", 3, 18)); // NOI18N
        jTextField1.setText("Fisico");
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 200, -1, -1));
